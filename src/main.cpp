...
/////
// motors
pros::Motor intakelow(8,pros::MotorGearset::blue);
pros::Motor extramotor(-11, pros::MotorGearset::green);
pros::Motor leftlady(14);
pros::Motor rightlady(15);
pros::Rotation lady(13);
//pistons
...
int a=0;
int b=0;
int targetAngle = 24.6;
void opcontrol() {
  // This is preference to what you like to drive on
  chassis.drive_brake_set(MOTOR_BRAKE_COAST);
 rightlady.set_brake_mode(pros::E_MOTOR_BRAKE_HOLD);
 leftlady.set_brake_mode(pros::E_MOTOR_BRAKE_HOLD);
  while (true) {
    // Gives you some extras to make EZ-Template ezier
    ez_template_extras();
    int currentAngle = lady.get_angle();

        if (master.get_digital(pros::E_CONTROLLER_DIGITAL_DOWN)) {
rightlady.move_velocity(30);
leftlady.move_velocity(-30);
    }if
...
leftlady.move_velocity(30);
 ...
 rightlady.move_velocity(0);
 leftlady.move_velocity(0);
    ...
    // . . .
        ...
        //this is my test code for the intake
        if (master.get_digital(DIGITAL_R1)) {
            intakelow.move_velocity(-600);
            extramotor.move_velocity(-300);
			//hehe i 
